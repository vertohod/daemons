...
request_look_for_channel = "{\"id\":4,\"tp\":\"command\",\"vr\":1,\"pl\":{\"tp\":\"look_for_channel\",\"vr\":1,\"text\":\"\"}}"
request_come_in = "{\"id\":5,\"tp\":\"command\",\"vr\":1,\"pl\":{\"tp\":\"come_in\",\"vr\":1,\"channel_oid\":1964630416631}}"
request_message1 = "{\"id\":22,\"tp\":\"message\",\"vr\":1,\"channel_oid\":1964630416631,\"sender_oid\":112233,\"recipient_oid\":0,\"time\":0,\"encrypted\":false,\"payload\":\"some text\"}"
request_message2 = "{\"id\":33,\"tp\":\"message\",\"vr\":1,\"channel_oid\":1964630416632,\"sender_oid\":112233,\"recipient_oid\":0,\"time\":0,\"encrypted\":false,\"payload\":\"some text\"}"
request_get_history = "{\"id\":6,\"tp\":\"command\",\"vr\":1,\"pl\":{\"tp\":\"get_history\",\"vr\":1,\"channel_oid\":1964630416631,\"time\":2147483647}}"
...
def on_open(ws):
    def run(*args):
        ...
        send(ws, request_message1)
        send(ws, request_message1)
        send(ws, request_message1)
        send(ws, request_message1)
        send(ws, request_message2)
        send(ws, request_message2)
        send(ws, request_message2)
        send(ws, request_message2)
        send(ws, request_get_history)
